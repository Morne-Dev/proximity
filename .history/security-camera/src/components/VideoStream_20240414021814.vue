    ...
    <v-card-text>
      <v-container>
        <v-row justify="center">
          <v-col cols="12">
            <video ref="video" :autoplay="displayVideo" muted style="width: auto; height: auto;"></video>
    ...
    .then(stream => {
      ...
      if (videoElement) {
        ...
        videoElement.addEventListener('loadeddata', () => {
          videoElement.removeEventListener('loadeddata', arguments.callee);
          predictObjects();
        });
      }
    })
