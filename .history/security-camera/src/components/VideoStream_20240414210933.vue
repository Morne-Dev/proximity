    ...
    <v-card-text>
      <v-container fluid>
        <v-row justify="center">
          <v-col cols="12">
            <v-img src="" class="video-container" ref="videoContainer">
...
function adjustCanvasSize() {
  ...
  if (videoElement && videoContainerElement && canvasElement) {
    // Set canvas dimensions to match video stream
    canvasElement.style.width = videoElement.style.videoWidth + 'px';
    canvasElement.style.height = videoElement.style.videoWidth + 'px'
    
    // Set the size of the video container
    videoContainerElement.width = videoElement.videoWidth;
    videoContainerElement.height = videoElement.videoHeight;
  }
}
