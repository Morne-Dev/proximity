      ...
      <v-row justify="center">
        <v-col cols="12" md="8" lg="6">
          ...
          <section ref="demosSection" v-if="showBtn">
            <v-card class="camView" height="460">
              <v-video v-if="!camStarted" ref="video" autoplay muted></v-video>
              <v-btn v-else color="secondary" @click="enableCam">Enable Webcam</v-btn>
            </v-card>
